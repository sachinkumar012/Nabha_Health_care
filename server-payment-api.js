...
const WEBHOOK_SECRET = process.env.RAZORPAY_WEBHOOK_SECRET || '69f8825c-ae86-4a76-89d5-501a621e772e';
...
app.post('/api/payments/verify', (req, res) => {
  try {
    ...
    const expectedSignature = crypto
      .createHmac('sha256', process.env.RAZORPAY_KEY_SECRET || 'iup6OxBjjs22NfyIV2vN4x8p')
