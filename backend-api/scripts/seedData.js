...
const hospitalsData = [
  {
    ...
    specialties: [{
      ...
      services: ['Normal Delivery', 'C-Section', 'Prenatal Care', 'Postnatal Care']
    }, {
  ...
  },
  {
    ...
    specialties: [{
      ...
      services: ['General Consultation', 'Preventive Medicine', 'Health Checkups']
    }, {
      name: 'Pediatrics',
    ...
    services: {
      ...
      laboratory: {
        available: true,
        services: ['Complete Blood Count', 'Biochemistry', 'Microbiology', 'Pathology'],
        hours: '24x7'
      },
      radiology: {
        available: true,
    ...
    const sampleOrders = [
      {
        ...
        summary: {
          subtotal: (medicines[0].pricing.sellingPrice * 2) + medicines[1].pricing.sellingPrice,
          deliveryCharges: 0,
          tax: 0,
          total: (medicines[0].pricing.sellingPrice * 2) + medicines[1].pricing.sellingPrice
        },
        delivery: {
          type: 'home_delivery',
          address: {
        ...
        payment: {
          method: 'razorpay',
          status: 'completed',
          amount: (medicines[0].pricing.sellingPrice * 2) + medicines[1].pricing.sellingPrice
        },
        pharmacy: {
    ...
    const sampleRecords = [
      {
        ...
        presentIllness: 'Patient complains of fever (101°F) and headache for the past 2 days',
        vitalSigns: {
