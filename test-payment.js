...
async function runAllTests() {
  ...
  console.log(
    "💡 To test actual payment flow, go to pharmacy page and add items to cart."
  );
  ...
  const testActualPayment = confirm(
    "Do you want to test the actual payment modal? (It will open Razorpay checkout - cancel to avoid charges)"
  );
