...
class AIChatNotifier extends StateNotifier<AIChatState> {
  ...
  Future<Map<String, dynamic>> _callGeminiAPI(String userMessage, String language) async {
    try {
      ...
      print('📝 Request body: ${requestBodyString.length > 200 ? requestBodyString.substring(0, 200) + "..." : requestBodyString}');
      ...
      print('📄 API Response Body: ${responseBodyString.length > 500 ? responseBodyString.substring(0, 500) + "..." : responseBodyString}');
